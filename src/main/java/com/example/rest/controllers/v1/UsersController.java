...
import com.example.rest.error.ResponseModel;
import com.example.rest.forms.UserRegistrationForm;
import com.example.rest.forms.UserUpdateForm;
...
public class UsersController {
    ...
    public ResponseEntity<Object> signUp(@Valid @RequestBody UserRegistrationForm user,
        ...
        if (result.hasErrors()) {
            ...
            User newUser = users.save(toUserEntity(user));
    ...
    public ResponseEntity<Object> getUser(@PathVariable("userId") Long userId) {
        ...
        final Optional<User> user = users.getUserById(userId);
    ...
    private User toUserEntity(UserRegistrationForm userRegistrationForm) {
    ...
    private User toUserEntity(String username, UserUpdateForm updateForm) {
